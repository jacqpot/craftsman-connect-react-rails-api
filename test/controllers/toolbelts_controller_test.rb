...
class ToolbeltsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create toolbelt" do
    assert_difference('Toolbelt.count') do
      post toolbelts_url, params: { toolbelt: { craftsman_id: @toolbelt.craftsman_id, skill_id: @toolbelt.skill_id } }, as: :json
    end
  ...
  test "should update toolbelt" do
    patch toolbelt_url(@toolbelt), params: { toolbelt: { craftsman_id: @toolbelt.craftsman_id, skill_id: @toolbelt.skill_id } }, as: :json
    assert_response 200
  end
